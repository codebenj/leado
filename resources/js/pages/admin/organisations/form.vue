<template>
  <Section dusk="organisationForm" className="organisation-form" :pageTitle="pageTitle">
    <template v-slot:extra>
      <div class="el-form-item manual-escalation fl-right">
        <label class="filter-labels"> Escalation </label>
        <el-switch
      ...
      <div class="el-form-item manual-escalation fl-right">
        <label class="filter-labels"> Org Status </label>
        <el-switch
         ...
         <el-row :gutter="24">
            ...
            <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
              <el-form-item label="Address" prop="address">
                <vue-google-autocomplete
                  id="search"
                  v-model="orgForm.address_search"
          ...
          <el-row :gutter="24">
            <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
              ...
              <el-form-item>
                <div class="el-form-item manual-escalation fl-left">
                  <el-switch
                  ...
                  <el-radio-group v-model="orgForm.suspension_type" v-if="!showSendOrgNotification()">
            ...
            <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
              ...
              <label style="font-size:14px; color: #606266">Lead Escalation Notification</label>
            ...
            <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
              <el-form-item
                ...
                "
              >
                <el-select v-model="orgForm.priority" clearable placeholder="Select option">
                  <el-option
                    v-for="prio in 5"
                    :key="'priority-' + prio"
                    :label="prio"
          ...
          <el-row :gutter="24">
            <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
              ...
              <div class="el-form-item manual-escalation fl-left">
                <el-checkbox v-if="!sendOrgNotification" v-model="orgForm.send_org_notification">Send Org SMS and Email Notification</el-checkbox>
                <el-checkbox v-if="sendOrgNotification" v-model="orgForm.low_priority">Low Priority</el-checkbox>
              </div>
              </el-form-item>
            </el-col>
