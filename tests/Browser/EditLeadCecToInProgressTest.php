...
use Tests\Browser\Pages\AdminLeadToCec;
...
class EditLeadCecToInProgressTest extends DuskTestCase
{
    ...
    /** @test */
    public function edit_lead_cec_to_in_progress_awaiting_response_success(){
        $this->browse(function (Browser $browser) {
            ...
            $browser->visit(new AdminLeadToCec)
                ->pause(5000);
            ...
            $browser->screenshot('edit_lead_cec_to_in_progress_awaiting_response_success');
        });
    }

    /** @test */
    public function edit_lead_cec_to_in_progress_awaiting_response_email_sent_success(){
        $this->browse(function (Browser $browser) {
            ...
            $browser->screenshot('edit_lead_cec_to_in_progress_awaiting_response_email_sent_success');
        });
    }

    /** @test */
    public function edit_lead_cec_to_in_progress_awaiting_response_admin_notified_success(){
        $this->browse(function (Browser $browser) {
            ...
            $browser->screenshot('edit_lead_cec_to_in_progress_awaiting_response_admin_notified_success');
        });
    }

    /** @test */
    public function edit_lead_cec_to_in_progress_awaiting_response_discontinued_success(){
        $this->browse(function (Browser $browser) {
            ...
            $browser->screenshot('edit_lead_cec_to_in_progress_awaiting_response_discontinued_success');
        });
    }

    /** @test */
    public function edit_lead_cec_to_in_progress_awaiting_response_parked_success(){
        $this->browse(function (Browser $browser) {
            ...
            $this->assertDatabaseHas('lead_escalations', ['escalation_status' => 'Parked', 'is_active' => 1]);

            $browser->screenshot('edit_lead_cec_to_in_progress_awaiting_response_parked_success');
        });
    }
}
